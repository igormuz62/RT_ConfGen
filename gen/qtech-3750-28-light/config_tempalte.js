var config_template = "\
Для подключения к коммутатору концентрации по оптике использовать порты Ethernet1/0/27-Ethernet1/0/28</br>\n\
Для подключения по меди использовать порт Ethernet1/0/26</br>\n\
</br>\n\
...
Команда просмотра установленной конфигурации: show running-config</br>\n\
";
